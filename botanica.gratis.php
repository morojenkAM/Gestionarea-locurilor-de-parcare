...
<head>
 ...
 /* Adăugați prefixul "search-" la clasele CSS implicate în căutare */
.search-container {
    position: absolute;
    top: 10.8%;
    left: 50%;
...
.search-button:focus {
    ...
    <title>Botanica,locuri de parcare gratuita</title>
</head>
<body>
<div class="image-container" id="image-container">
        <img src="gratuita_botanica.png" alt="Imaginea" id="image">
        <div class="search-container">
    <form class="search-form" action="#">
        <input type="text" placeholder="Cauta strada" class="search-input" name="search">
        <button type="submit" class="search-button">Cauta strada</button>
    </form>
</div>

        <div class="label" id="label1" style="left: 37%; top: 7.8%;" onclick="showLabel(10, 13, 1)">1</div>
        <div class="label" id="label2" style="left: 46.3%; top: 26%;" onclick="showContainer2(17, 39, 2)">2</div>
        <div class="label" id="label3" style="left: 42.83%; top: 52.98%;" onclick="showContainer2(20, 65, 3)">3</div>
        <div class="label" id="label4" style="left: 45.07%; top: 53.45%;" onclick="showContainer2(56, 62, 4)">4</div>
        <div class="label" id="label5" style="left: 49.23%; top: 66.75%;" onclick="showContainer2(30, 70, 5)">5</div>
        <div class="label" id="label6" style="left: 50.9%; top: 81% ;" onclick="showContainer2(57, 70, 6)">6</div>
