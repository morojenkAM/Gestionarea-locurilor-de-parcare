...
<body>
    ...
    <nav>
        ...
        <a href="admin_abonamente.php">Abonamente</a>
        <a href="adauga_utilizatori.php" class="add-button"><button>Adaugă</button></a>
    </nav>
    ...
    <tr>
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<td><a href="Edit.php?edit_id=' . $row['IDUtilizatori'] . '"><button>Editare</button></a> <a href="Delete.php?delete_id=' . $row['IDUtilizatori'] . '"><button class="delete">Ștergere</button></a></td>';
            echo "</tr>";
        }
