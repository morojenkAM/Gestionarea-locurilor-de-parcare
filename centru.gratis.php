...
<head>
    ...
    <title>Centru,locuri de parcare gratuita</title>
</head>
<body>
<div class="image-container" id="image-container">
        <img src="gratis_centru.jpg" alt="Imaginea" id="image">
        <div class="label" id="label1" style="left: 60.3%; top: 72.6%;" onclick="showLabel(30, 65, 1)">1</div>
        <div class="label" id="label2" style="left: 62%; top: 73.39%;" onclick="showContainer2(72, 70, 2)">2</div>
        <div class="label" id="label3" style="left: 55.7%; top: 35.29%;" onclick="showContainer2(30, 45, 3)">3</div>
        <div class="label" id="label4" style="left: 62.17%; top: 31.78%;" onclick="showContainer2(68, 43, 4)">4</div>
        <div class="label" id="label5" style="left: 55.1%; top: 42.5%;" onclick="showContainer2(42, 52, 5)">5</div>
        <div class="label" id="label6" style="left: 56.3%; top: 40.5% ;" onclick="showContainer2(57, 70, 6)">6</div>
<div class="label" id="label6" style="left: 56.3%; top: 40.5% ;" onclick="showContainer2(65, 45, 6)">6</div>
