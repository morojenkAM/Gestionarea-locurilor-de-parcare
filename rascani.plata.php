...
<head>
    ...
    <title>Rascani,locuri de parcare cu plata</title>
</head>
<body>
<div class="image-container" id="image-container">
        <img src="rascani_cu_plata.jpg" alt="Imaginea" id="image">
        <div class="label" id="label1" style="left: 50.69%; top: 13.8%;" onclick="showLabel(34, 19, 1)">1</div>
        <div class="label" id="label2" style="left: 54.9%; top: 21.7%;" onclick="showContainer2(65, 34, 2)">2</div>
        <div class="label" id="label3" style="left: 30.7%; top: 30.4%;" onclick="showContainer2(14, 40, 3)">3</div>
        <div class="label" id="label4" style="left: 31.38%; top: 47.2%;" onclick="showContainer2(12, 59, 4)">4</div>
        <div class="label" id="label5" style="left: 18.5%; top: 80.8%;" onclick="showContainer2(5, 70, 5)">5</div>
        <div class="label" id="label6" style="left: 25.6%; top: 84.5% ;" onclick="showContainer2(31, 70, 6)">6</div>
        <div class="label" id="label6" style="left: 65.5%; top: 81.5% ;" onclick="showContainer2(50, 70, 6)">7</div>
        
    </div>

    <div class="label-text-container" id="label-text-container1">
        <h1>Studentilor 9/11</h1>
    ...
    <div class="label-text-container" id="label-text-container2">
        <h1>Academecian Sergiu Radauteanu 1</h1>
        <div class="parking-lot">
            <?php for ($i = 1; $i <= 10; $i++) { ?>
