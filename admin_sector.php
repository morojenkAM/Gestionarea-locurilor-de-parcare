...
<body>
    ...
    <nav>
        ...
        <a href="adauga_sector.php" class="add-button"><button>Adaugă</button></a>
    </nav>
    ...
    <table>
        <tr>
            ...
            $result = $conn->query("SELECT * FROM sector");
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<td><a href="Edit_sector.php?edit_id=' . $row['IDSector'] . '"><button>Editare</button></a> <a href="sterge_sector.php?delete_id=' . $row['IDSector'] . '"><button class="delete">Ștergere</button></a></td>';
                echo "</tr>";
            }
