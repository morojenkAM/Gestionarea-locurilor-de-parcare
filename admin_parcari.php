...
<body>
    ...
    <nav>
        ...
        <a href="adauga_parcari.php" class="add-button"><button>Adaugă</button></a>
    </nav>
    ...
    <tr>
        ...
        $result = $conn->query("SELECT * FROM parcari");
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<td><a href="Edit_parcari.php?edit_id=' . $row['IDParcare'] . '"><button>Editare</button></a> <a href="sterge_parcari.php?delete_id=' . $row['IDParcare'] . '"><button class="delete">Ștergere</button></a></td>';
            echo "</tr>";
        }
