...
<head>
    ...
    <title>Buiucani,locuri de parcare cu plata</title>
</head>
<body>
<div class="image-container" id="image-container">
        <img src="buiucani_cu_plata.jpg" alt="Imaginea" id="image">
        <div class="label" id="label1" style="left: 28.5%; top: 27.4%;" onclick="showLabel(5, 30, 1)">1</div>
        <div class="label" id="label2" style="left: 30.65%; top: 29.6%;" onclick="showContainer2(8, 42, 2)">2</div>
        <div class="label" id="label3" style="left: 39.39%; top: 41.1%;" onclick="showContainer2(15, 53, 3)">3</div>
        <div class="label" id="label4" style="left: 50.7%; top: 39%;" onclick="showContainer2(60, 45, 4)">4</div>
        <div class="label" id="label5" style="left: 42.19%; top: 58%;" onclick="showContainer2(13, 70, 5)">5</div>
        <div class="label" id="label6" style="left: 50.57%; top: 68.65% ;" onclick="showContainer2(63, 70, 6)">6</div>

        
    </div>

    <div class="label-text-container" id="label-text-container1">
        <h1>Liviu Deleanu 5/3</h1>
...
<div class="label-text-container" id="label-text-container5">
        <h1>Piața Unirii Principatelor 1</h1>
        <div class="parking-lot">
            <?php for ($i = 1; $i <= 10; $i++) { ?>
                <div class="parking-spot common-spot" data-spot="<?php echo $i; ?>" onclick="showForm(<?php echo $i; ?>)"><?php echo $i; ?></div>
            <?php } ?>
