...
<body>
    ...
    <nav>
        <a href="admin_sector.php">Sector</a>
        ...
        <a href="adauga_abonamente.php" class="add-button"><button>Adaugă</button></a>
    </nav>
    ...
    <tr>
        ...
        $result = $conn->query("SELECT * FROM abonamente");
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<td><a href="Edit_abonamente.php?edit_id=' . $row['IDAbonamente'] . '"><button>Editare</button></a> <a href="sterge_abonamnte.php?delete_id=' . $row['IDAbonamente'] . '"><button class="delete">Ștergere</button></a></td>';
            echo "</tr>";
        }
