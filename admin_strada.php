...
<body>
    ...
    <nav>
        ...
        <a href="adauga_strada.php" class="add-button"><button>Adaugă</button></a>
    </nav>
    ...
    <tr>
        ...
        $result = $conn->query("SELECT * FROM strada");
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<td><a href="Edit_strada.php?edit_id=' . $row['IDStrada'] . '"><button>Editare</button></a> <a href="sterge_strada.php?delete_id=' . $row['IDStrada'] . '"><button class="delete">Ștergere</button></a></td>';
            echo "</tr>";
        }
