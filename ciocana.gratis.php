...
<head>
    ...
    <title>Ciocana,locuri de parcare gratuita</title>
</head>
<body>
<div class="image-container" id="image-container">
        <img src="parcare gratuita.png" alt="Imaginea" id="image">
        <div class="label" id="label1" style="left: 34.8%; top: 96.3%;" onclick="showLabel(15, 80, 1)">1</div>
        <div class="label" id="label2" style="left: 46%; top: 83.5%;" onclick="showContainer2(46, 83.5, 2)">2</div>
        <!-- Adăugați altele după cum este necesar -->
    </div>

    <div class="label-text-container" id="label-text-container1">
        <h1>Mihail Sadoveanu 10/2</h1>
    ...
    <div class="label-text-container" id="label-text-container2">
        <h1>Bulevardul Mircea cel Batran 12/2</h1>
        <div class="parking-lot">
            <?php for ($i = 1; $i <= 10; $i++) { ?>
