...
<head>
    ...
    <title>Botanica,locuri de parcare cu plata</title>
</head>
<body>
<div class="image-container" id="image-container">
        <img src="botanica_cu_plata.png" alt="Imaginea" id="image">
        <div class="label" id="label1" style="left: 40.19%; top: 16.4%;" onclick="showLabel(15, 20, 1)">1</div>
        <div class="label" id="label2" style="left: 49.65%; top: 76.38%;" onclick="showContainer2(28, 70, 2)">2</div>
        <div class="label" id="label3" style="left: 57.59%; top: 83.5%;" onclick="showContainer2(65, 70, 3)">3</div>
       
    </div>

    <div class="label-text-container" id="label-text-container1">
        <h1>Bulevardul Dacia 13</h1>
